...
if st.button("🔮 Υπολογισμός Χρόνου Αποκατάστασης"):
    ...
    # Σύγκριση με παρόμοιες περιπτώσεις (π.χ. με βάση ηλικιακή ομάδα & τύπο κατάγματος)
    similar = df[
    ...
    if not similar.empty:
        ...
        st.info(f"🔍 Μέσος χρόνος αποκατάστασης για παρόμοιες περιπτώσεις: **{int(round(avg_days))} εβδομαδες**")
    else:
        st.info("Δεν βρέθηκαν αρκετά παρόμοια περιστατικά για σύγκριση.")
